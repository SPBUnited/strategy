...
if __name__ == '__main__':
    ...
    processors = [
        ...
        RefereeCommandsCollector(processing_pause=0.01, should_debug=True),
        MatlabController(should_debug=True),
        RobotCommandsSender(processing_pause=0.001, should_debug=True)
    ]
