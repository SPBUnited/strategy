...
class WType(Enum):
    ...
    S_STOP = 4 # Kostil for stopping 
    S_KEEP_BALL_DISTANCE = 5

    R_PASSTHROUGH = 6 # Двигаться в точку не останавливаясь (промежуточная точка пути)

    R_BALL_ALIGN = 7 # Выровнятся напротив мяча, приготовившись его захватить
    _GRAVEYARD = 100
