...
class Field:
    ...
    def __init__(self) -> None:
        ...
        self.b_team = [ entity.Entity(const.GRAVEYARD_POS, 0, const.ROBOT_R) for _ in range(const.TEAM_ROBOTS_MAX_COUNT)]
        self.y_team = [ entity.Entity(const.GRAVEYARD_POS, 0, const.ROBOT_R) for _ in range(const.TEAM_ROBOTS_MAX_COUNT)]
